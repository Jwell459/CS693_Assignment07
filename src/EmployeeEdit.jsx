                    ...
                    <Card.Text>
                        <Container fluid>
                            <form name="employeeUpdate" onSubmit={this.handleSubmit}>
                                ...
                                <Alert variant={this.state.alertColor} show={this.state.alertVisible} onClose={(e) => this.setState(this.setState({ alertVisible: false }))} dismissible>{this.state.alertMessage}</Alert>
                            </form>
                        </Container>
                    </Card.Text>
                </Card.Body>
